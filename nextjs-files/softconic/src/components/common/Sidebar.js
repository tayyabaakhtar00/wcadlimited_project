      ...
      <div className="sidebar-menu-area">
        <ul className="menu-list">
          <li className="menu-item-has-children menu-item ">
            <a href="#" className="drop-down" data-hover="Home">Home</a><i className={`bi  dropdown-icon2 ${state.activeMenu === "home-one" ? "bi-dash-lg" : "bi-plus-lg"}`}   onClick={() => collapseMenu("home-one")}/>
          ...
          <li className="menu-item-has-children menu-item">
            <Link legacyBehavior href="/blog-grid" data-hover="Service"><a>Service</a></Link><i className={`bi  dropdown-icon2 ${state.activeMenu === "service" ? "bi-dash-lg" : "bi-plus-lg"}`}   onClick={() => collapseMenu("service")}/>
          ...
          <li className="menu-item-has-children menu-item">
            <Link legacyBehavior href="/blog-grid" data-hover="Project"><a>Project</a></Link><i className={`bi  dropdown-icon2 ${state.activeMenu === "projects" ? "bi-dash-lg" : "bi-plus-lg"}`}   onClick={() => collapseMenu("projects")}/>
          ...
          <li className="menu-item-has-children menu-item">
            <Link legacyBehavior href="/blog-grid" data-hover="Case Study"><a>Case Study</a></Link><i className={`bi  dropdown-icon2 ${state.activeMenu === "case" ? "bi-dash-lg" : "bi-plus-lg"}`}   onClick={() => collapseMenu("case")}/>
          ...
          <li className="menu-item-has-children menu-item">
            <Link legacyBehavior href="/blog-grid" data-hover="Blog"><a>Blog</a></Link><i className={`bi  dropdown-icon2 ${state.activeMenu === "blog" ? "bi-dash-lg" : "bi-plus-lg"}`}   onClick={() => collapseMenu("blog")}/>
          ...
          <li className="menu-item-has-children menu-item">
            <Link legacyBehavior href="/blog-grid" data-hover="Pages"><a>Pages</a></Link><i className={`bi  dropdown-icon2 ${state.activeMenu === "pages" ? "bi-dash-lg" : "bi-plus-lg"}`}   onClick={() => collapseMenu("pages")}/>
